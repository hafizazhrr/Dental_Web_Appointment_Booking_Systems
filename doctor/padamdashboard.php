            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li class="active">
                            <a href="doctordashboard.php"><i class="fa fa-fw fa-dashboard"></i><b> DASHBOARD</b></a>
                        </li>
                        <li>
                            <a href="addschedule.php"><i class="fa fa-fw fa-table"></i><b> DOCTOR SCHEDULE</b></a>
                        </li>
                        <li>
                            <a href="patientlist.php"><i class="fa fa-fw fa-edit"></i><b> PATIENT LIST</b></a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                echo "<tr class='$status'>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$appointment['appId']."' class='delete'>DELETE</a>
                            </td>";
